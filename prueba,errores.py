...
class ERPApp:
    def __init__(self, root, db_connector):
        ...
        self.producto_personal = tk.StringVar()
        ...
        self.personal_apellido = tk.StringVar()
        self.personal_cargo = tk.StringVar()
        ...
        # Pestaña de Personal
        self.personal_label = tk.Label(self.personal_tab, text='Registrar Personal')
        ...
        self.personal_apellido_label = tk.Label(self.personal_tab, text='Apellido:')
        self.personal_apellido_label.pack()
        self.personal_apellido_entry = tk.Entry(self.personal_tab, textvariable=self.personal_apellido)
        self.personal_apellido_entry.pack()

        self.personal_cargo_label = tk.Label(self.personal_tab, text='Cargo:')
        self.personal_cargo_label.pack()
        self.personal_cargo_entry = tk.Entry(self.personal_tab, textvariable=self.personal_cargo)
        self.personal_cargo_entry.pack()
        ...
        self.resultados_tree = ttk.Treeview(self.busqueda_tree_tab,
                                            columns=('ID', 'Nombre', 'Cantidad', 'Concepto', 'Monto', 'Acción'))
    ...
    def registrar_personal(self):
        ...
        apellido = self.personal_apellido.get()
        cargo = self.personal_cargo.get()

        if nombre and apellido and cargo:
            query = f"INSERT INTO personal (nombre, apellido, cargo) VALUES ('{nombre}', '{apellido}', '{cargo}')"
            self.db_connector.execute_query(query)
            self.personal_nombre.set('')
            self.personal_apellido.set('')
            self.personal_cargo.set('')
